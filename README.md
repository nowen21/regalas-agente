...
- [`plantillas/ciclo-vida-proyectos/06-especificacion-modulo.md`](plantillas/ciclo-vida-proyectos/06-especificacion-modulo.md) — esqueleto para redactar la especificación de un módulo (se copia por módulo a `documentacion/`)
