...
| `F4.1 · Preguntas que TODO plan debe responder` | `:112` | ❌ | `M4` `M5` | ID / tamaño | H-15, H-16 · ID decimal; 28 líneas. La exigencia ("responder las 13") es única y legítima | Legalizar el sub-ID o promover a `F14`; llevar las 13 preguntas a `plantillas/planes/trabajo.md` y dejar el enlace | Media |
