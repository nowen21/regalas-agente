...
## Los programas: 18 amarrados de 54

**Un tercio.** El resto —36— solo lee y escribe archivos, y funcionaría igual con cualquier agente o sin ninguno.
...
`acciones.py` · `aislamiento.py` · `calidad.py` · `cerrar.py` · `ci.py` · `citas.py` · `codigo.py` · `commits.py` · `comun.py` · `cruces.py` · `declaracion.py` · `dependencias.py` · `enlaces.py` · `enmascarar.py` · `entidades.py` · `errores.py` · `esquema.py` · `estructura.py` · `fases.py` · `flujo.py` · `herramientas.py` · `marcas.py` · `metareglas.py` · `migraciones.py` · `numeracion.py` · `pendientes.py` · `plantillas.py` · `rama.py` · `relacionadas.py` · `rendimiento.py` · `resumen.py` · `secretos.py` · `seguridad.py` · `trazabilidad.py` · `validar.py` · `versionado.py`
