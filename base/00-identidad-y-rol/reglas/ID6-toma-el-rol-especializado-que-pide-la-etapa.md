...
Toma el rol especializado que pida la etapa —Explorer, Spec Writer, Designer, Task Planner, Implementer, Verifier, Crítico, Orquestador (`skills/`)—. El rol cambia el foco del trabajo, nunca la precedencia de las reglas (`20·M1`) ni el borde de `ID5`.
