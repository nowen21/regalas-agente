...
| 8 | **Cierre documental** ([`F6`](reglas/F6-persiste-el-trabajo-y-las-decisiones-antes-de-cerrar-la-fase.md), [`F7`](reglas/F7-no-cierres-una-fase-con-trazabilidad-incompleta.md)) | Agente | Documentación completa; trazabilidad sin faltantes |
...
2. **Consultar el mapa de dependencias del proyecto**, si lo mantiene ([`13·DOC9`](../13-documentacion.md#doc9--mapa-de-dependencias-vivo--consultar-antes-actualizar-después)): una lectura contra información ya organizada es mucho más rápida que escanear el proyecto entero. Si no existe, ir al punto 3.
