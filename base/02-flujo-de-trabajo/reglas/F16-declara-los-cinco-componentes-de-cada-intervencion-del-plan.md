...
**20 filas: 19 ✅ · 0 ❌ · 1 N/A.** N/A — **16**: no tiene excepción. Es la primera de las dos exigencias que `F4.3` tenía juntas —declararlo y verificarlo se cumplen por separado—; la segunda es [`F17`](F17-verifica-contra-el-proyecto-real-todo-lo-que-el-plan-afirma.md).
