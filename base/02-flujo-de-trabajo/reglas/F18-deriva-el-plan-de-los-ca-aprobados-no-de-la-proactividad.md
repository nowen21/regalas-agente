...
**20 filas: 20 ✅ · 0 ❌ · 0 N/A.** Toma el contenido de `F4.4`, cuyo ID decimal no admitía [`M4`](../../20-meta-reglas/reglas/M4-cada-regla-tiene-un-identificador-unico-estable-y-prefijado.md) — era su único ❌.
