...
| [`DOC3`](reglas/DOC3-verifica-la-trazabilidad-spec-implementacion-antes-de-cerrar.md) | Cada afirmación de la spec se verifica contra lo construido antes de cerrar. |
...
| Regla | Qué exige |
|---|---|
| [`DOC6`](reglas/DOC6-retro-documenta-el-modulo-sin-spec-antes-de-tocarlo.md) | Un módulo productivo sin spec se retro-documenta antes de intervenirlo. |
