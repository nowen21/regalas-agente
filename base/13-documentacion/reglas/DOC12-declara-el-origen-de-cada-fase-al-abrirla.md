...
Toda fase nueva abre declarando de dónde sale, en una de tres formas: **modifica** fases anteriores —nombrándolas—, **agrega** funcionalidad que no existía, o **ambas**. El formato del bloque está en [`plantillas/fase.md`](../../../plantillas/fase.md), y la carpeta de la fase repite el mismo ORIGEN que su spec. Sin esto aparecen fases sueltas y nadie sabe si continúan el plan o reaccionan a un hallazgo.
