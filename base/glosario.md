...
| **Resultado de pruebas** | — | El documento que dice qué se ejecutó, con qué se probó y qué dio | Agente, al correr las pruebas | `resultado_pruebas.md` de la fase | [`02·F12.13`](02-flujo-de-trabajo/reglas/F12-relacion-y-nomenclatura-de-fases.md) |
