...
| **Checklist de despliegue** | Del inglés "lista de chequeo": se recorre marcando antes de sacar el sistema al servidor | La lista de lo que hay que revisar antes y después de publicar, y que se entrega junto con el despliegue | Agente | Junto al despliegue del proyecto | [`18·DP6`](18-despliegue-e-infraestructura.md#dp6--checklist-de-despliegue) |
...
| **Mapeo de nombres** | — | La tabla que dice cómo se llama en este proyecto cada cosa que la base nombra en abstracto: catálogo, permiso, auditoría | Usuario del proyecto | `.agente/mapeo-nombres.md` | [`02·F13`](02-flujo-de-trabajo/reglas/F13-deja-la-estructura-base-puesta-antes-de-trabajar.md) |
...
| **Postmortem** | En latín, "después de la muerte": se escribe cuando algo ya falló | Lo que se escribe después de un incidente: qué pasó, por qué, y qué se cambia para que no vuelva. Sin buscar culpables | Agente | Donde el proyecto guarde sus incidentes | [`19·OB5`](19-observabilidad-y-operacion.md#ob5--postmortem-sin-culpa) |
...
| **Stack** | En inglés, "pila": las tecnologías apiladas una sobre otra | Con qué está hecho el proyecto: lenguaje, framework, base de datos, y dónde vive el código | Usuario del proyecto | `.agente/stack.md` | [`02·F13`](02-flujo-de-trabajo/reglas/F13-deja-la-estructura-base-puesta-antes-de-trabajar.md) |
