...
| Usan otra marca | 2 | [`plantillas/ciclo-vida-proyectos/03-epica.md`](../../plantillas/ciclo-vida-proyectos/03-epica.md) con `[Resultado observable…]` y `<slug>`; [`plantillas/marco-normativo.md`](../../plantillas/marco-normativo.md) con `` `<nombre>` `` |
