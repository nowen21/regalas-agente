...
- **Los términos en inglés del capítulo** (`preview`, `dry-run`, `backup`, `drop`, `truncate`). Está anotado en los pendientes [21](../../../../../pendientes/21-el-glosario-y-los-terminos-en-ingles.md) y [26](../../../../../pendientes/26-corrida-y-ejecucion-en-el-estandar.md), y no se abre acá.
