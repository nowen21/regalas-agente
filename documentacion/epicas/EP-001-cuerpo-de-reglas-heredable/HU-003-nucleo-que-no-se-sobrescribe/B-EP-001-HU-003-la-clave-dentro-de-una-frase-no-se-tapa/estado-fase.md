# Estado de fase — Fase `B-EP-001-HU-003-la-clave-dentro-de-una-frase-no-se-tapa` (módulo Cuerpo de reglas)   ·   `[CAPA 3]`
...
| **Planteamiento / Épica / HU** | [EP-001](../../epica.md) · [HU-003](../HU-003-nucleo-que-no-se-sobrescribe.md) |
...
|---|---|
| **Concepto** | **Cumple** |
| **CA cumplidos** | 1 de 1, el CA-02, la clave no queda en claro |
| **CA en "No"** | Ninguno |
