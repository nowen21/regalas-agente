...
- **Estación:** 4 — pausa y presentación. **Motivo:** el plan está escrito y sin aprobar, y sin el proyecto de la duda 1 no arranca ninguno de los tres CA. **Qué falta para desbloquear:** que el usuario apruebe el plan, elija el proyecto y decida la forma del caso del CA-03.
