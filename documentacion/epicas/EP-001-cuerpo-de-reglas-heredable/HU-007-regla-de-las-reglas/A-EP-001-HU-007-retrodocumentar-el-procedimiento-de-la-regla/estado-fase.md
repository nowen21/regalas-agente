...
| 4 | Pausa y presentación | 👤 pendiente: falta presentarlo y recuperar las candidatas de la duda 1 | ☐ |
...
- **[`validadores/metareglas.py`](../../../../../validadores/metareglas.py) no se puede correr** (pendiente [53](../../../../../pendientes/53-enlaces-py-no-tiene-punto-de-entrada.md)): la fila 5 se decide leyendo, y el resultado tiene que decirlo.
...
- **Estación:** 4 — pausa y presentación. **Motivo:** el plan está escrito y sin aprobar, y la duda 1 deja dos casos sin datos. **Qué falta para desbloquear:** que el usuario apruebe el plan y recuerde qué candidatas se rechazaron. Cuatro de las ocho tareas pueden arrancar apenas se apruebe.
