# Resultado de Pruebas — Fase `A-EP-001-HU-016-retrodocumentar-el-capitulo-03`   ·   `[CAPA 3]`
...
| Campo | Valor |
|---|---|
| **Fase** (`02·F12.6`) | `A-EP-001-HU-016-retrodocumentar-el-capitulo-03` |
| **HU** | [HU-016](../HU-016-el-capitulo-03-datos-y-persistencia.md) |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Abrir `base/03-datos.md` y leer su cabecera | Nombra la HU-016 | Nombra la HU-016 |
| 2 | Comprobar que el enlace apunta a un archivo que **existe** | Resuelve | `../documentacion/epicas/EP-001-cuerpo-de-reglas-heredable/HU-016-el-capitulo-03-datos-y-persistencia/HU-016-el-capitulo-03-datos-y-persistencia.md` → **resuelve** |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Comprobar que la HU-016 existe | Existe | Existe |
...
| CP-001 | CA-01 | **Crítica** | 2026-08-28 | la cabecera de `base/03-datos.md`, y su enlace **resuelve** | Aprobado | EV-01 | — |
...
| 2 | Que el capítulo tiene sus reglas donde el analizador las ve | `metareglas.reglas()` | **12 regla(s)** |
...
|---|---|---|---|
| CA-01 — el capítulo nombra su historia dueña | CP-000, CP-001 | Nombra la HU-016, y el enlace **resuelve** | Sí |
...
| EV-01 | La cabecera del capítulo | `base/03-datos.md` |
