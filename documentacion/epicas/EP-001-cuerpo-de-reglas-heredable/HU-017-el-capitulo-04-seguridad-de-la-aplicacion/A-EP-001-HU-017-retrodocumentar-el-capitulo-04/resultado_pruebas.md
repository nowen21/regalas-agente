# Resultado de Pruebas — Fase `A-EP-001-HU-017-retrodocumentar-el-capitulo-04`   ·   `[CAPA 3]`
...
| Campo | Valor |
|---|---|
| **Fase** (`02·F12.6`) | `A-EP-001-HU-017-retrodocumentar-el-capitulo-04` |
| **HU** | [HU-017](../HU-017-el-capitulo-04-seguridad-de-la-aplicacion.md) |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Abrir `base/04-seguridad.md` y leer su cabecera | Nombra la HU-017 | Nombra la HU-017 |
| 2 | Comprobar que el enlace apunta a un archivo que **existe** | Resuelve | `../documentacion/epicas/EP-001-cuerpo-de-reglas-heredable/HU-017-el-capitulo-04-seguridad-de-la-aplicacion/HU-017-el-capitulo-04-seguridad-de-la-aplicacion.md` → **resuelve** |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Comprobar que la HU-017 existe | Existe | Existe |
...
| CP-001 | CA-01 | **Crítica** | 2026-08-28 | la cabecera de `base/04-seguridad.md`, y su enlace **resuelve** | Aprobado | EV-01 | — |
...
| 2 | Que el capítulo tiene sus reglas donde el analizador las ve | `metareglas.reglas()` | **18 regla(s)** |
...
|---|---|---|---|
| CA-01 — el capítulo nombra su historia dueña | CP-000, CP-001 | Nombra la HU-017, y el enlace **resuelve** | Sí |
...
| EV-01 | La cabecera del capítulo | `base/04-seguridad.md` |
