# Plan de Pruebas — Fase `A-EP-001-HU-021-retrodocumentar-el-capitulo-08`   ·   `[CAPA 3]`

**Para qué sirve este documento.** Dice **con qué casos concretos se comprueba** el criterio de esta fase, con qué datos y cuándo se da por aprobado. Lo que se pide vive en la [HU-021](../HU-021-el-capitulo-08-estrategia-de-pruebas.md); lo que se va a hacer, en el [plan_trabajo.md](plan_trabajo.md).
...
Comprobar que el capítulo `08` **nombra su historia dueña con un enlace que resuelve**, y que un cambio suyo **tiene dónde bajarse**.
...
| # | Acción | Resultado esperado |
|---|---|---|
| 1 | Abrir `base/08-pruebas.md` y leer su cabecera | Nombra la HU-021 |
...
| # | Acción | Resultado esperado |
|---|---|---|
| 1 | Comprobar que la HU-021 existe con su documento | Existe |
