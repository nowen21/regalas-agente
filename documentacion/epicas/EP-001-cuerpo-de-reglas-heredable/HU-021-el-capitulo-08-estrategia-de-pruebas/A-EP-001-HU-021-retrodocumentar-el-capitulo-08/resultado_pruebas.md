# Resultado de Pruebas — Fase `A-EP-001-HU-021-retrodocumentar-el-capitulo-08`   ·   `[CAPA 3]`
...
| Campo | Valor |
|---|---|
| **Fase** (`02·F12.6`) | `A-EP-001-HU-021-retrodocumentar-el-capitulo-08` |
| **HU** | [HU-021](../HU-021-el-capitulo-08-estrategia-de-pruebas.md) |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Abrir `base/08-pruebas.md` y leer su cabecera | Nombra la HU-021 | Nombra la HU-021 |
| 2 | Comprobar que el enlace apunta a un archivo que **existe** | Resuelve | `../documentacion/epicas/EP-001-cuerpo-de-reglas-heredable/HU-021-el-capitulo-08-estrategia-de-pruebas/HU-021-el-capitulo-08-estrategia-de-pruebas.md` → **resuelve** |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Comprobar que la HU-021 existe | Existe | Existe |
...
| CP-001 | CA-01 | **Crítica** | 2026-08-28 | la cabecera de `base/08-pruebas.md`, y su enlace **resuelve** | Aprobado | EV-01 | — |
...
|---|---|---|---|
| CA-01 — el capítulo nombra su historia dueña | CP-000, CP-001 | Nombra la HU-021, y el enlace **resuelve** | Sí |
...
| EV-01 | La cabecera del capítulo | `base/08-pruebas.md` |
