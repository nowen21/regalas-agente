# HU-024 — El capítulo `11` · Configuración y entornos: su texto tiene dueña
...
| **Módulo / Componente** | Capítulo `11` · Configuración y entornos |
| **Tipo** | Técnica |
| **Prioridad** | Should |
| **Estimación** | S |
...
- **Quiero** que el texto del capítulo `11` tenga una historia de usuario dueña, que diga de dónde baja cada una de sus reglas y reciba todo cambio de su texto
...
| ID | Regla |
|---|---|
| RN-01 | Todo cambio del texto del capítulo `11` entra como fase de esta historia (`02·F23`) |
...
```gherkin
Dado que el capítulo 11 existe
...
1. Abrir [`base/11-configuracion-entornos.md`](../../../../base/11-configuracion-entornos.md). Resultado esperado: bajo el título hay una línea «Historia dueña del texto» que enlaza a esta historia.
- **Aprobado cuando:** la línea existe y el enlace resuelve.

### CA-02 — Un cambio del capítulo tiene dónde bajarse

```gherkin
Dado que hay que cambiar el texto de una regla del capítulo 11
...
1. Levantar con el andamio una fase de esta historia para un cambio cualquiera del capítulo (simulado). Resultado esperado: la fase se crea bajo `HU-024-el-capitulo-11-configuracion-y-entornos/`.
...
| Categoría | Requisito |
|---|---|
| Trazabilidad | Se puede nombrar, para el capítulo `11`, la historia donde se escribe su texto |
...
|---|---|---|
| [A-EP-001-HU-024-retrodocumentar-el-capitulo-11](A-EP-001-HU-024-retrodocumentar-el-capitulo-11/) | CA-01, CA-02 | **Terminada** · [Cumple](A-EP-001-HU-024-retrodocumentar-el-capitulo-11/resultado_pruebas.md) |
