# Plan de Pruebas — Fase `A-EP-001-HU-027-retrodocumentar-el-capitulo-14`   ·   `[CAPA 3]`

**Para qué sirve este documento.** Dice **con qué casos concretos se comprueba** el criterio de esta fase, con qué datos y cuándo se da por aprobado. Lo que se pide vive en la [HU-027](../HU-027-el-capitulo-14-estructura-del-codigo-y-nomenclatura.md); lo que se va a hacer, en el [plan_trabajo.md](plan_trabajo.md).
...
Comprobar que el capítulo `14` **nombra su historia dueña con un enlace que resuelve**, y que un cambio suyo **tiene dónde bajarse**.

### 1.2 Alcance

**Entra:** la cabecera del capítulo, su enlace, y que la historia exista con su §8 lista para recibir la fila de una fase.

**No entra:** el contenido de sus 3 reglas, sus checklists, ni su comprobación automática.
...
| # | Acción | Resultado esperado |
|---|---|---|
| 1 | Abrir `base/14-estructura-codigo.md` y leer su cabecera | Nombra la HU-027 |
...
| # | Acción | Resultado esperado |
|---|---|---|
| 1 | Comprobar que la HU-027 existe con su documento | Existe |
