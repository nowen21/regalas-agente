# Plan de Pruebas — Fase `A-EP-001-HU-029-retrodocumentar-el-capitulo-16`   ·   `[CAPA 3]`

**Para qué sirve este documento.** Dice **con qué casos concretos se comprueba** el criterio de esta fase, con qué datos y cuándo se da por aprobado. Lo que se pide vive en la [HU-029](../HU-029-el-capitulo-16-cumplimiento-y-calidad.md); lo que se va a hacer, en el [plan_trabajo.md](plan_trabajo.md).
...
Comprobar que el capítulo `16` **nombra su historia dueña con un enlace que resuelve**, y que un cambio suyo **tiene dónde bajarse**.

### 1.2 Alcance

**Entra:** la cabecera del capítulo, su enlace, y que la historia exista con su §8 lista para recibir la fila de una fase.

**No entra:** el contenido de sus 0 reglas, sus checklists, ni su comprobación automática.
...
| # | Acción | Resultado esperado |
|---|---|---|
| 1 | Abrir `base/16-cumplimiento-y-calidad.md` y leer su cabecera | Nombra la HU-029 |
...
| # | Acción | Resultado esperado |
|---|---|---|
| 1 | Comprobar que la HU-029 existe con su documento | Existe |
