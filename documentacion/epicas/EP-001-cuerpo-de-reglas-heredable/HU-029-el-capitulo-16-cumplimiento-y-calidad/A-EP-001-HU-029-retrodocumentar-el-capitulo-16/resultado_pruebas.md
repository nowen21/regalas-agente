# Resultado de Pruebas — Fase `A-EP-001-HU-029-retrodocumentar-el-capitulo-16`   ·   `[CAPA 3]`
...
| Campo | Valor |
|---|---|
| **Fase** (`02·F12.6`) | `A-EP-001-HU-029-retrodocumentar-el-capitulo-16` |
| **HU** | [HU-029](../HU-029-el-capitulo-16-cumplimiento-y-calidad.md) |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Abrir `base/16-cumplimiento-y-calidad.md` y leer su cabecera | Nombra la HU-029 | Nombra la HU-029 |
| 2 | Comprobar que el enlace apunta a un archivo que **existe** | Resuelve | `../documentacion/epicas/EP-001-cuerpo-de-reglas-heredable/HU-029-el-capitulo-16-cumplimiento-y-calidad/HU-029-el-capitulo-16-cumplimiento-y-calidad.md` → **resuelve** |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Comprobar que la HU-029 existe | Existe | Existe |
...
| CP-001 | CA-01 | **Crítica** | 2026-08-28 | la cabecera de `base/16-cumplimiento-y-calidad.md`, y su enlace **resuelve** | Aprobado | EV-01 | — |
...
| 2 | Que el capítulo tiene sus reglas donde el analizador las ve | `metareglas.reglas()` | **0 regla(s)** |

**El cero de la fila 2 no dice que el capítulo esté vacío: dice que el analizador no lo ve.** Está en `B-EP-004-HU-002`.
...
|---|---|---|---|---|---|
| D-01 | **El analizador cuenta cero reglas en este capítulo**, y el capítulo no está vacío | La verificación manual 2 | Media | **Abierto**, con destino | `B-EP-004-HU-002-el-analizador-ve-todas-las-reglas`, que existe para esto |

**Defectos abiertos que se aceptan y por qué:** `D-01`. **No es de esta fase**: corregir el analizador o el encabezado del capítulo está fuera de su alcance, y su fase ya existe. Se declara para que el cero no se lea como «capítulo vacío».
...
|---|---|---|---|
| CA-01 — el capítulo nombra su historia dueña | CP-000, CP-001 | Nombra la HU-029, y el enlace **resuelve** | Sí |
...
| EV-01 | La cabecera del capítulo | `base/16-cumplimiento-y-calidad.md` |
