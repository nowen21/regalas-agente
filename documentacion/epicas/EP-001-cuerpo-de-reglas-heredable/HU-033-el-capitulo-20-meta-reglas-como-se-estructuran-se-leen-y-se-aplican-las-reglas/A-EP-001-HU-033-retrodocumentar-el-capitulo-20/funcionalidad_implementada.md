# Funcionalidad implementada — Fase `A-EP-001-HU-033-retrodocumentar-el-capitulo-20` (módulo Cuerpo de reglas)   ·   `[CAPA 3]`
...
| Campo | Valor |
|---|---|
| **Fase** (identificador · `02·F12.6`) | `A-EP-001-HU-033-retrodocumentar-el-capitulo-20` |
| **Módulo** | Cuerpo de reglas |
| **Especificación del módulo** | La redacción de los CA de la [HU-033](../HU-033-el-capitulo-20-meta-reglas-como-se-estructuran-se-leen-y-se-aplican-las-reglas.md) es la especificación funcional (`02·F19`) |
| **Plan de trabajo** | [plan_trabajo.md](plan_trabajo.md) |
| **HU / CA cubiertas** | HU-033 (CA-01, CA-02) |
...
**Nada: se comprobó.** Es retro-documentación (`13·DOC6`). El capítulo `20` ya nombraba su historia dueña en la cabecera; lo que faltaba era **dejarlo verificado y darle a la historia una fase donde bajen sus cambios**.

Con esto, el capítulo `20` y sus **20 reglas** dejan de ser texto sin dueño declarado: tienen historia, y la historia tiene por dónde recibir un cambio.
...
|---|---|---|---|---|
| CA-01 — el capítulo nombra su historia dueña | doc | `base/20-meta-reglas/base.md`, su cabecera | ✅ | El enlace **resuelve** |
| CA-02 — un cambio tiene dónde bajarse | doc | `HU-033-el-capitulo-20-meta-reglas-como-se-estructuran-se-leen-y-se-aplican-las-reglas.md` §8 | ✅ | `validar.py fases` deja de reclamar |
...
| T-01 | La cabecera nombra y el enlace resuelve | ✅ hecha | `base/20-meta-reglas/base.md` | `CP-001` |
| T-02 | La historia recibe la fila | ✅ hecha | `HU-033-el-capitulo-20-meta-reglas-como-se-estructuran-se-leen-y-se-aplican-las-reglas.md` | `CP-002` |
...
- **Verificaciones manuales** (`08·T4`):
  ...
  - El capítulo tiene **20 regla(s)** donde el analizador las ve.
...
- **Punto de entrada:** la cabecera del capítulo `20`. Quien vaya a cambiarlo lee ahí por dónde baja el cambio.
