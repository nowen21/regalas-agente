# Resultado de Pruebas — Fase `A-EP-001-HU-034-retrodocumentar-el-capitulo-21`   ·   `[CAPA 3]`
...
| Campo | Valor |
|---|---|
| **Fase** (`02·F12.6`) | `A-EP-001-HU-034-retrodocumentar-el-capitulo-21` |
| **HU** | [HU-034](../HU-034-el-capitulo-21-automatizacion-de-procesos.md) |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Abrir `base/21-automatizacion-de-procesos.md` y leer su cabecera | Nombra la HU-034 | Nombra la HU-034 |
| 2 | Comprobar que el enlace apunta a un archivo que **existe** | Resuelve | `../documentacion/epicas/EP-001-cuerpo-de-reglas-heredable/HU-034-el-capitulo-21-automatizacion-de-procesos/HU-034-el-capitulo-21-automatizacion-de-procesos.md` → **resuelve** |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Comprobar que la HU-034 existe | Existe | Existe |
...
| CP-001 | CA-01 | **Crítica** | 2026-08-28 | la cabecera de `base/21-automatizacion-de-procesos.md`, y su enlace **resuelve** | Aprobado | EV-01 | — |
...
|---|---|---|---|
| CA-01 — el capítulo nombra su historia dueña | CP-000, CP-001 | Nombra la HU-034, y el enlace **resuelve** | Sí |
...
| EV-01 | La cabecera del capítulo | `base/21-automatizacion-de-procesos.md` |
