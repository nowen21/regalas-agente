...
|---|---|---|---|---|
| [CP-001](plan_pruebas.md#cp-001--la-marca-se-ve-sin-buscarla) | [CA-01](../HU-001-marca-de-espacio-por-llenar.md#ca-01--la-marca-se-ve-y-se-distingue-del-texto) | `plantillas/HU.md`, `plantillas/epica.md` y `plantillas/senales.md` | Cumple | Recuento a ojo y con `grep`: el mismo número |
...
**Detalle de CP-001.** Se abrieron `plantillas/HU.md`, `plantillas/epica.md` y `plantillas/senales.md` y se recorrieron de arriba abajo una vez. Los huecos se pudieron señalar sin volver atrás. Después se contaron a ojo y con `grep -c "«"`: el mismo número en las tres.
