...
| Tarea | Estado | Nota |
|---|---|---|
| T-01 | Pendiente | Incremento en la especificación del módulo. Va con lo que salga de la medición |
| T-02 | Pendiente | Prueba del encadenamiento HU ↔ épica — CP-001 |
| T-03 | Pendiente | Caso de los criterios comprobables — CP-002 |
| T-04 | Pendiente | Caso del encargo a medias — CP-003 |
| T-05 | Pendiente | Constancia del planteamiento faltante — CP-004 |
