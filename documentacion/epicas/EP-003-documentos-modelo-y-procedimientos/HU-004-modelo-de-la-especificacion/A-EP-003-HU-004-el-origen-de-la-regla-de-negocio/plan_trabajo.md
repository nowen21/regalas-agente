...
| `plantillas/ciclo-vida-proyectos/06-especificacion-modulo.md` | Modificar | Modelo | El §4 pide las dos cosas |
...
**Verificado el 2026-08-16:** el §4 de [`plantillas/ciclo-vida-proyectos/06-especificacion-modulo.md`](../../../../../plantillas/ciclo-vida-proyectos/06-especificacion-modulo.md) está en la línea 30 y hoy pide `1. «Regla — por qué existe.»`.
