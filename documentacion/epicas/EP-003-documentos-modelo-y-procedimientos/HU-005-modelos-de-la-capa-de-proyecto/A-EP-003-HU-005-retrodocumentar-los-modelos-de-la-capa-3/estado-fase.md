...
| Tarea | Estado | Nota |
|---|---|---|
| T-01 | Pendiente | Incremento en la especificación: qué dato es de cuál modelo. Va con lo que salga de T-02 |
| T-02 | Pendiente | Caso del dato con un solo dueño — CP-001 |
| T-03 | Pendiente | Prueba de la declaración mal escrita — CP-002 |
| T-04 | Pendiente | Prueba del silencio sin declaración de stack — CP-003 |
| T-05 | Pendiente | Caso del dominio declarado a medias — CP-004 |
