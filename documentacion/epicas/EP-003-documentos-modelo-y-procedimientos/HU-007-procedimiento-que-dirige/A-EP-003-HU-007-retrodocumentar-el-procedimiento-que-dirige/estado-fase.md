...
| 6 | Ejecución continua | 7 tareas · **dudas decididas el 2026-08-18** | ☐ |
...
| **CA cumplidos** | 3 de 3 |
| **CA en "No"** | Ninguno |
| **Defectos abiertos aceptados** | D-01, el procedimiento no manda verificar la línea base al retomar un plan |
