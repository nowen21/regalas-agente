...
- **Estación:** 4 — pausa y presentación. **Motivo:** el plan está escrito y sin aprobar, y sin el encargo de la duda 1 no arrancan el CA-01 ni el CA-02. **Qué falta para desbloquear:** que el usuario apruebe el plan y elija el encargo. El CA-03 y la comparación pueden arrancar apenas se apruebe.
