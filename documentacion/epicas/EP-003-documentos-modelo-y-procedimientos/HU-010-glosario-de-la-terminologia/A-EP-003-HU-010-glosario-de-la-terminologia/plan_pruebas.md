...
| 3 | Contrastar la lista contra los nombres de los roles en `skills/`, `base/00-identidad-y-rol/reglas/ID6…` y `plantillas/estado-fase.md` | Se ve cuáles hay que cambiar y en qué archivos |
