...
**Retro-documenta.** El formato existe y lo usan los 24 subcomandos: [`comun.py`](../../../../../validadores/comun.py) define el hallazgo y las dos severidades — la falla rompe la ejecución, el aviso no. Falta el contrato escrito y la prueba de que el código de salida es el que corresponde.
