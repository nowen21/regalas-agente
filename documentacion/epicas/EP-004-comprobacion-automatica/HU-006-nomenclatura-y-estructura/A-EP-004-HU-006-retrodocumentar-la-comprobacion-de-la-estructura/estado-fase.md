...
| Tarea | Estado | Nota |
|---|---|---|
| T-01 | Pendiente | Caso del nombre mal armado y el complemento válido — CP-001 |
| T-02 | Pendiente | Caso del hueco en el consecutivo — CP-002 |
| T-03 | Pendiente | Caso de la fase incompleta — CP-003 |
| T-04 | Pendiente | Anotar la cuenta de avisos como línea base fechada — CP-004 |
