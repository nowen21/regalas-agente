...
| Tarea | Estado | Nota |
|---|---|---|
| T-01 | Pendiente | Caso de la clave armada — CP-001 |
| T-02 | Pendiente | Caso del archivo que no debe versionarse — CP-002 |
| T-03 | Pendiente | Caso del ejemplo que no es clave — CP-003 |
| T-04 | Pendiente | Levantar del programa la lista de lo que cuenta como ejemplo — CP-004 |
