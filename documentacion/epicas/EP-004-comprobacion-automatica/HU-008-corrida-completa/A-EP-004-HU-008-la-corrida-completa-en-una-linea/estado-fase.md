...
| 6 | Ejecución continua | 6 tareas · **detenida por la duda 1 de §2.7** | ☐ |
...
- **Estación:** 6 — ejecución continua, detenida. **Motivo:** el plan **está aprobado** desde el 2026-08-17, y la duda 1 bloquea los CA-01 y CA-03, que son lo que la fase construye. **Qué falta para desbloquear:** que el usuario decida si lo lento entra a la corrida completa. El CA-02 puede arrancar apenas se apruebe, y conviene que sea lo primero: fija la línea base.
