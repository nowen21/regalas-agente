...
**Qué cerró.** El [pendientes/53-enlaces-py-no-tiene-punto-de-entrada.md](../../../../../pendientes/hecho/ningun-validador-termina-en-silencio.md), sus dos puntos: ningún módulo de `validadores/` sale ya con código 0 en silencio —eran **33 de 45**— y `metareglas.py` tiene su subcomando.
