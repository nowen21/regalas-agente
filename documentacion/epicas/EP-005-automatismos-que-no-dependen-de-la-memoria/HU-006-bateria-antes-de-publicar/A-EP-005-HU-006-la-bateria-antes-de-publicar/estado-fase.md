...
| **CA cumplidos** | 0 de 2 |
| **CA en "No"** | Los **dos están en «No» de entrada**: no hay batería que correr antes de publicar |
...
- **Estación:** 4 — pausa y presentación. **Motivo:** el plan está escrito y sin aprobar, y las dos dudas bloquean las cinco tareas. Además, la fase depende de que exista la corrida completa de EP-004 · HU-008. **Qué falta para desbloquear:** que el usuario apruebe el plan, decida si se espera a esa corrida y qué cuenta como publicar.
