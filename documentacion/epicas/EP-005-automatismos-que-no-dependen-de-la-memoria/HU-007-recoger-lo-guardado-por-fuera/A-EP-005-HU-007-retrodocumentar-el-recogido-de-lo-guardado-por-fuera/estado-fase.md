...
| **CA cumplidos** | 0 de 2 |
| **CA en "No"** | Ninguno todavía. Los dos **corren hoy**; lo que falta es la prueba escrita, y en particular la del choque de nombres |
...
| Tarea | Estado | Nota |
|---|---|---|
| T-01 | Pendiente | Caso del recuerdo que llega al repositorio — CP-001 |
| T-02 | Pendiente | Caso del almacén que queda vacío — CP-002 |
| T-03 | Pendiente | Prueba de que no se sobrescribe — CP-003 |
| T-04 | Pendiente | Caso del choque de nombres — CP-004 |
