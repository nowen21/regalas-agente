# Estado de fase — Fase `D-EP-005-HU-008-el-criterio-de-salida-se-vuelve-a-medir` (módulo Enganche del resumen)   ·   `[CAPA 3]`
...
| **Planteamiento / Épica / HU** | [EP-005](../../epica.md) · [HU-008](../HU-008-enganche-del-resumen.md) |
...
|---|---|
| **Concepto** | **Cumple** |
| **CA cumplidos** | 1 de 1 — Criterio de salida · la comprobación en una sesión real |
| **CA en "No"** | Ninguno |
...
| Tarea | Estado | Nota |
|---|---|---|
| T-01 · ejecutar el criterio que quedó en rojo | Terminada | colgado, y la sesion real dejo resumen e indice coherentes tras renombrar |
