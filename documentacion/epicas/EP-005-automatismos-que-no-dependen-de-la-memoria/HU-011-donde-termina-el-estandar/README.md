# HU-011-donde-termina-el-estandar

Contenido inmediato de esta carpeta.

| Qué | De qué se trata |
|---|---|
| [HU-011-donde-termina-el-estandar.md](HU-011-donde-termina-el-estandar.md) | La historia de usuario: el mapa de qué pieza sirve con cualquier agente y cuál está amarrada a la herramienta de hoy |
