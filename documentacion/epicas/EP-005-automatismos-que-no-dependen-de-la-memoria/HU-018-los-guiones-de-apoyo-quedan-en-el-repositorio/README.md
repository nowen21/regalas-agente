# HU-018-los-guiones-de-apoyo-quedan-en-el-repositorio
...
**La regla existía y se dejó de cumplir al día siguiente de precisarla.** Cuatro días, 38 guiones en una carpeta temporal del sistema. El **resultado** de cada cambio quedaba versionado y **el cómo se borraba con el temporal**.

**Lo que se agrega:** la regla `04·S18`, que dice **dónde sí** van —la mitad que le faltaba a `04·S9`, que solo dice dónde no—, y el enganche que lo hace cumplir.

**Lo que no cubre, dicho de frente:** lo que se escribe desde una línea de comandos. Cubre `Write` y `Edit`, que es por donde se escribieron los 38.
