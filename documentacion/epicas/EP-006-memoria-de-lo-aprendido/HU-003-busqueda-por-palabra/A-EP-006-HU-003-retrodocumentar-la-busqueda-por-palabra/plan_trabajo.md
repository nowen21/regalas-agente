...
**ORIGEN** ([`13·DOC12`](../../../../../base/13-documentacion/reglas/DOC12-declara-el-origen-de-cada-fase-al-abrirla.md)): 📄 **Retro-documentación** ([`13·DOC6`](../../../../../base/13-documentacion/reglas/DOC6-retro-documenta-el-modulo-sin-spec-antes-de-tocarlo.md)). La búsqueda existe y no necesita instalar nada: [`memoria/memoria.py`](../../../../../memoria/memoria.py) busca con el índice de texto completo que ya trae la base, y el índice ignora acentos a propósito. Sale de la fila de HU-003 en el pendiente [48](../../../../../pendientes/48-inventario-hu.md).
