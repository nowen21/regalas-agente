# Estado de fase — Fase `B-EP-006-HU-005-manda-el-recuerdo-y-la-senal-se-reemplaza` (módulo Memoria)   ·   `[CAPA 3]`
...
| **Módulo** | Memoria |
| **Planteamiento / Épica / HU** | [EP-006](../../epica.md) · [HU-005](../HU-005-separar-aprendizaje-de-preferencia.md) |
...
|---|---|
| **Concepto** | **Cumple** |
| **CA cumplidos** | 1 de 1, el CA-01, nada está guardado en los dos sitios diciendo cosas distintas |
| **CA en "No"** | Ninguno |
