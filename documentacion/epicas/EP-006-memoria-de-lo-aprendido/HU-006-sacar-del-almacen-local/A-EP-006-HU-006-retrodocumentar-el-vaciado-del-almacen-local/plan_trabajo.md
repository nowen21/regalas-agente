...
**ORIGEN** ([`13·DOC12`](../../../../../base/13-documentacion/reglas/DOC12-declara-el-origen-de-cada-fase-al-abrirla.md)): 📄 **Retro-documentación** ([`13·DOC6`](../../../../../base/13-documentacion/reglas/DOC6-retro-documenta-el-modulo-sin-spec-antes-de-tocarlo.md)). El vaciado existe y corre solo: [`recuerdos.py`](../../../../../validadores/recuerdos.py) y [`hook_recuerdos.py`](../../../../../validadores/hook_recuerdos.py) recogen del almacén local de la herramienta y lo dejan vacío, como exige `01·C19`. Es la otra cara de [EP-005 · HU-007](../../../EP-005-automatismos-que-no-dependen-de-la-memoria/HU-007-recoger-lo-guardado-por-fuera/HU-007-recoger-lo-guardado-por-fuera.md): allá se prueba el enganche, acá el resultado. Sale de la fila de HU-006 en el pendiente [48](../../../../../pendientes/48-inventario-hu.md).
