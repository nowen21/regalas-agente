...
| `enlaces.py` no tiene bloque `__main__`: correrlo directo no imprime nada y sale con código 0 | No previsto — se descubrió en esta sesión, fuera de esta fase | Anotado en el [pendiente 41](../../../../../pendientes/41-el-marcador-no-se-resuelve-dentro-de-un-proyecto.md) |
