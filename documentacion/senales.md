...
- **Learned:** una ruta que cabe deja de caber al anidarse, y el margen se lo come el prefijo, no el archivo. Cuando un diseño copie árboles ajenos dentro del propio, **la longitud de la ruta es una restricción de diseño**, no un detalle de la máquina: o el prefijo es corto, o los nombres largos hay que acortarlos, o se asume que hace falta configuración extra y se dice dónde.
