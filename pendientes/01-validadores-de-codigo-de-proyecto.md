...
| **`DOC14`-formato** — link de dos partes con texto = ruta absoluta. Forzarlo marca todo link de texto descriptivo → alto FP | [EP-004 · HU-005 — Enlaces y citas](../documentacion/epicas/EP-004-comprobacion-automatica/HU-005-enlaces-y-citas/HU-005-enlaces-y-citas.md), su `RN-03`. Su deuda de texto es el [18](hecho/los-enlaces-del-estandar-no-cumplen-doc14.md) |
