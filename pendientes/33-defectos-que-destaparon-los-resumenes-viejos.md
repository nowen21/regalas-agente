...
**6 · Nadie revisó a qué proyectos les borró la memoria el enganche.** → **Se fue de acá el 2026-08-16**, al [pendiente 39](39-a-que-proyectos-les-borro-la-memoria-el-enganche.md). Era el más urgente de esta lista y de todo el backlog, y mientras viviera dentro de este archivo heredaba la prioridad del promedio de los otros siete puntos. El texto completo está allá.
