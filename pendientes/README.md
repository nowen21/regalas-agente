...
| 19 | **P1** | [El capítulo 20 no se cumple a sí mismo](19-el-capitulo-20-no-se-cumple-a-si-mismo.md) | De 188 reglas, 129 sin checklist, 7 publicadas en "no cumple" y 33 sin clasificar. Clasificadas, con bloque y, desde la v30.8.0, **ninguna en «no cumple»**. Queda la partición de las 26 con más de una exigencia (MAYOR), que el usuario aprobó. |
