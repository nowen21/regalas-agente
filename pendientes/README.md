...
| 73 | **P3** | [La guía del desarrollo profesional es doctrina del estándar, no de un proyecto](73-la-guia-del-desarrollo-profesional-es-doctrina-del-estandar-no-de-un-proyecto.md) | matematica | La guía del ciclo de desarrollo quedó escrita en un proyecto y debe heredarse a todos: es contenido de `base/` (EP-001). Su material llegó adjunto en el 73-adjunto. |
| 73-adjunto | — | [Adjunto: la guía del desarrollo profesional](73-adjunto-guia-desarrollo-profesional.md) | matematica | El material del 73: la guía de diez pasos con cómo se vivió en el proyecto de origen. No es un pendiente propio: viaja con el 73 y cae con él. |
