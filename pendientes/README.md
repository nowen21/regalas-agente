...
| 03 | [Ciclo de vida de pendientes y deuda](03-ciclo-de-vida-de-pendientes.md) | Cerrar lo que el agente difiere: estado `cerrada` en las señales + comandos `pendientes` / `cerrar`. | El 02 ya dejó el gancho de migración y `estado` abierto; este solo suma `'cerrada'`. |
