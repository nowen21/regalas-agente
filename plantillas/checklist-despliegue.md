...
- [ ] El artefacto es el **mismo** que pasó pruebas y staging ([`18·DP3`](«RUTA-ESTANDAR»/base/18-despliegue-e-infraestructura.md#dp3--build-una-vez-promover-el-mismo-artefacto)) — no se recompila.
