...
[[Se llena ANTES de diseñar. Es el filtro de ambigüedad, `01·C7`.]]
...
[[Las invariantes que el código debe garantizar y que no se ven leyendo un archivo suelto, `13·DOC2`.]]
...
- [ ] Trazabilidad especificación → implementación sin faltantes (`13·DOC3`).
- [ ] Documentación persistida (regla `13`).
- [ ] «…»

## 12. Decisiones tomadas

[[Decisiones cerradas, para que no se reabran, `13·DOC2`. Fecha, motivo, y si se revierte una, dejar rastro.]]

- «`fecha`: decisión, y por qué.»

## 13. Trazabilidad (se completa al implementar)

[[Tabla de la `13·DOC3`: una fila por afirmación técnica de esta especificación, con dónde quedó implementada y su evidencia. Se llena al cerrar.]]
