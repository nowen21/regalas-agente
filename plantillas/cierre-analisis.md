...
- **Gaps generados** — cada `«gap-N»` queda en la §Qué falta del prompt vivo, listo para una fase futura ([`13·DOC12`](«RUTA-ESTANDAR»/base/13-documentacion/reglas/DOC12-declara-el-origen-de-cada-fase-al-abrirla.md) ORIGEN).
