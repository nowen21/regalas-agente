...
Puerta: sin inventario **aprobado por el usuario** no se derivan épicas ([`02·F26`](«RUTA-ESTANDAR»/base/02-flujo-de-trabajo/reglas/F26-el-inventario-de-funcionalidades-aprobado-es-la-puerta-de-las-epicas.md)).

Moldes: [02-inventario-funcionalidades](../ciclo-vida-proyectos/02-inventario-funcionalidades.md), [03-epica](../ciclo-vida-proyectos/03-epica.md) y [04-HU](../ciclo-vida-proyectos/04-HU.md)
...
Puerta: sin especificación acordada no hay código ([`02·F2`](«RUTA-ESTANDAR»/base/02-flujo-de-trabajo/reglas/F2-sin-especificacion-acordada-no-hay-codigo.md)).

Moldes: [06-especificacion-modulo](../ciclo-vida-proyectos/06-especificacion-modulo.md), [14-modelo-de-datos](../ciclo-vida-proyectos/14-modelo-de-datos.md), [15-diseno-de-interfaz](../ciclo-vida-proyectos/15-diseno-de-interfaz.md) y [16-documentacion-de-api](../ciclo-vida-proyectos/16-documentacion-de-api.md)
...
Moldes: [05-fase](../ciclo-vida-proyectos/05-fase.md), [07-plan-trabajo](../ciclo-vida-proyectos/07-plan-trabajo.md) ([`02·F14`](«RUTA-ESTANDAR»/base/02-flujo-de-trabajo/reglas/F14-responde-las-trece-preguntas-en-todo-plan-de-trabajo.md)) y [10-estado-fase](../ciclo-vida-proyectos/10-estado-fase.md)

## 5 · Pruebas

Con qué se comprueba cada criterio, y qué dio.

Va: los casos que cubren **cada** criterio de aceptación, escritos junto al plan de trabajo y aprobados con él ([`02·F4`](«RUTA-ESTANDAR»/base/02-flujo-de-trabajo/reglas/F4-todo-plan-lleva-su-plan-de-pruebas-y-su-aprobacion-explicita.md)); la evidencia de lo que se ejecutó; el veredicto criterio por criterio; y el cierre con lo que quedó hecho y la deuda que se declara.
...
Moldes: [08-plan-pruebas](../ciclo-vida-proyectos/08-plan-pruebas.md), [09-resultado-pruebas](../ciclo-vida-proyectos/09-resultado-pruebas.md) y [11-funcionalidad-implementada](../ciclo-vida-proyectos/11-funcionalidad-implementada.md)
...
Moldes: [17-manual-de-instalacion](../ciclo-vida-proyectos/17-manual-de-instalacion.md), [19-notas-de-version](../ciclo-vida-proyectos/19-notas-de-version.md) y [20-acta-de-entrega](../ciclo-vida-proyectos/20-acta-de-entrega.md)
...
Moldes: [18-manual-tecnico-y-de-operacion](../ciclo-vida-proyectos/18-manual-tecnico-y-de-operacion.md), [21-bitacora-de-operacion](../ciclo-vida-proyectos/21-bitacora-de-operacion.md) y [22-plan-de-mantenimiento](../ciclo-vida-proyectos/22-plan-de-mantenimiento.md)
