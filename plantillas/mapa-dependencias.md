...
> Artefacto **vivo** ([`13·DOC9`](../base/13-documentacion/reglas/DOC9-consulta-el-mapa-de-dependencias-antes-de-planificar.md)): la fuente autoritativa de "cómo está armado esto hoy". **Se consulta al planificar** (antes de explorar el código) y **se actualiza al cerrar** cada unidad de trabajo, en el mismo commit. La capa 3 declara su ruta (ej. `.agente/mapa-dependencias.md` local, o versionado si el equipo lo comparte). Reemplaza los `«…»` y borra esta caja.
>
