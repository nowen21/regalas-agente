...
> Catálogo de reglas **propias de este proyecto** ([`13·DOC10`](../base/13-documentacion/reglas/DOC10-registra-en-el-catalogo-del-proyecto-toda-regla-propia.md)) que sobrescriben o complementan la base común. Cada regla va numerada `P<N>` para poder citarse de forma estable desde especificaciones, planes y señales. Vive en `.agente/reglas-proyecto.md` (**local, no versionado** — es configuración del agente). Reemplaza los `«…»` y borra esta caja.
...
## Ninguna `P` se sostiene sola  ·  [`20·M16`](../base/20-meta-reglas/reglas/M16-toda-regla-de-proyecto-nombra-la-regla-de-base-que-concreta.md)
...
## Sincronización con la memoria  ·  [`13·DOC10`](../base/13-documentacion/reglas/DOC10-registra-en-el-catalogo-del-proyecto-toda-regla-propia.md)
...
- **Respaldo:** [`NN·Xn · Título de la regla de la base`](«enlace al archivo de la regla») · «concreta / endurece: qué mitad pone esta `P`». Obligatorio ([`20·M16`](../base/20-meta-reglas/reglas/M16-toda-regla-de-proyecto-nombra-la-regla-de-base-que-concreta.md)).
- **Por qué:** «el motivo: qué problema evita o qué convención del equipo fija».
- **Ejemplo:** «un caso concreto» (si ayuda a entenderla).
- **Señal asociada:** «id o enlace en la memoria ([`13·DOC5`](../base/13-documentacion/reglas/DOC5-registra-como-senal-lo-que-no-se-recupera-del-codigo.md))».
