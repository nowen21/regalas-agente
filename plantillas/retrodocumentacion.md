...
> **Cuándo.** Un módulo ya en producción que nunca tuvo especificación, o cuya especificación quedó más vieja que el código. Lo exige la regla [`13·DOC6`](«RUTA-ESTANDAR»/base/13-documentacion/reglas/DOC6-retro-documenta-el-modulo-sin-spec-antes-de-tocarlo.md) del capítulo 13 · Documentación.
>
...
**6 · Registrar el módulo.** En el catálogo de módulos del proyecto ([`13·DOC13`](«RUTA-ESTANDAR»/base/13-documentacion/reglas/DOC13-registra-cada-modulo-nuevo-en-el-catalogo-de-modulos.md)), con un puntero a la especificación recién creada.
...
Las preguntas del paso 4, cuando el usuario las responda, se cierran con la tabla de decisiones que pide [`13·DOC8`](«RUTA-ESTANDAR»/base/13-documentacion/reglas/DOC8-cierra-todo-analisis-con-su-tabla-de-decisiones.md) — no en el chat.
