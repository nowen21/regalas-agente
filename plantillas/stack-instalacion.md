...
|---|---|---|
| `f13` | La carpeta `proyectos/`, donde vive el código ([`02·F13`](«RUTA-ESTANDAR»/base/02-flujo-de-trabajo/reglas/F13-deja-la-estructura-base-puesta-antes-de-trabajar.md)). | La crea vacía. **No** mueve ni reorganiza código: qué va adentro es del usuario. |
