...
| **Concepto** | **No cumple** |
| **CA cumplidos** | 5 de 6 |
| **CA en "No"** | **CA-04.** `vigencia` sabe ordenar por antigüedad y las 249 reglas tienen la misma: ninguna revisión de utilidad |
| **Defectos abiertos aceptados** | D-01, falta un sello de utilidad distinto del de forma |
