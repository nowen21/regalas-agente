# HU-012-inventario-de-acciones-y-riesgo

Contenido inmediato de esta carpeta.

| Qué | De qué se trata |
|---|---|
| [HU-012-inventario-de-acciones-y-riesgo.md](HU-012-inventario-de-acciones-y-riesgo.md) | La historia de usuario: listar todo lo que el agente puede hacer y clasificarlo por qué tan difícil es deshacerlo |
