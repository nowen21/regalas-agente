# Plan de Pruebas — Fase `A-EP-001-HU-019-retrodocumentar-el-capitulo-06`   ·   `[CAPA 3]`

**Para qué sirve este documento.** Dice **con qué casos concretos se comprueba** el criterio de esta fase, con qué datos y cuándo se da por aprobado. Lo que se pide vive en la [HU-019](../HU-019-el-capitulo-06-rendimiento-y-eficiencia.md); lo que se va a hacer, en el [plan_trabajo.md](plan_trabajo.md).
...
Comprobar que el capítulo `06` **nombra su historia dueña con un enlace que resuelve**, y que un cambio suyo **tiene dónde bajarse**.
...
| # | Acción | Resultado esperado |
|---|---|---|
| 1 | Abrir `base/06-rendimiento.md` y leer su cabecera | Nombra la HU-019 |
...
| # | Acción | Resultado esperado |
|---|---|---|
| 1 | Comprobar que la HU-019 existe con su documento | Existe |
