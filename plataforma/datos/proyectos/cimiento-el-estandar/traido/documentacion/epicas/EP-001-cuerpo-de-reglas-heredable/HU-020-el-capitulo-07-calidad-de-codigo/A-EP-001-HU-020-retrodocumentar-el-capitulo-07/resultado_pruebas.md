# Resultado de Pruebas — Fase `A-EP-001-HU-020-retrodocumentar-el-capitulo-07`   ·   `[CAPA 3]`
...
| Campo | Valor |
|---|---|
| **Fase** (`02·F12.6`) | `A-EP-001-HU-020-retrodocumentar-el-capitulo-07` |
| **HU** | [HU-020](../HU-020-el-capitulo-07-calidad-de-codigo.md) |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Abrir `base/07-calidad-de-codigo.md` y leer su cabecera | Nombra la HU-020 | Nombra la HU-020 |
| 2 | Comprobar que el enlace apunta a un archivo que **existe** | Resuelve | `../documentacion/epicas/EP-001-cuerpo-de-reglas-heredable/HU-020-el-capitulo-07-calidad-de-codigo/HU-020-el-capitulo-07-calidad-de-codigo.md` → **resuelve** |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Comprobar que la HU-020 existe | Existe | Existe |
...
| CP-001 | CA-01 | **Crítica** | 2026-08-28 | la cabecera de `base/07-calidad-de-codigo.md`, y su enlace **resuelve** | Aprobado | EV-01 | — |
...
|---|---|---|---|
| CA-01 — el capítulo nombra su historia dueña | CP-000, CP-001 | Nombra la HU-020, y el enlace **resuelve** | Sí |
...
| EV-01 | La cabecera del capítulo | `base/07-calidad-de-codigo.md` |
