# Plan de Pruebas — Fase `A-EP-001-HU-023-retrodocumentar-el-capitulo-10`   ·   `[CAPA 3]`

**Para qué sirve este documento.** Dice **con qué casos concretos se comprueba** el criterio de esta fase, con qué datos y cuándo se da por aprobado. Lo que se pide vive en la [HU-023](../HU-023-el-capitulo-10-dependencias-de-terceros.md); lo que se va a hacer, en el [plan_trabajo.md](plan_trabajo.md).
...
Comprobar que el capítulo `10` **nombra su historia dueña con un enlace que resuelve**, y que un cambio suyo **tiene dónde bajarse**.
...
| # | Acción | Resultado esperado |
|---|---|---|
| 1 | Abrir `base/10-dependencias.md` y leer su cabecera | Nombra la HU-023 |
...
| # | Acción | Resultado esperado |
|---|---|---|
| 1 | Comprobar que la HU-023 existe con su documento | Existe |
