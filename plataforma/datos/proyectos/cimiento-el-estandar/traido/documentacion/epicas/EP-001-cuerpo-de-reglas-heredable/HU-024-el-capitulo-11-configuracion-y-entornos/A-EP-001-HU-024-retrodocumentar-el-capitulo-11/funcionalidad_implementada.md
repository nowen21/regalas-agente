# Funcionalidad implementada — Fase `A-EP-001-HU-024-retrodocumentar-el-capitulo-11` (módulo Cuerpo de reglas)   ·   `[CAPA 3]`
...
| Campo | Valor |
|---|---|
| **Fase** (identificador · `02·F12.6`) | `A-EP-001-HU-024-retrodocumentar-el-capitulo-11` |
| **Módulo** | Cuerpo de reglas |
| **Especificación del módulo** | La redacción de los CA de la [HU-024](../HU-024-el-capitulo-11-configuracion-y-entornos.md) es la especificación funcional (`02·F19`) |
| **Plan de trabajo** | [plan_trabajo.md](plan_trabajo.md) |
| **HU / CA cubiertas** | HU-024 (CA-01, CA-02) |
...
**Nada: se comprobó.** Es retro-documentación (`13·DOC6`). El capítulo `11` ya nombraba su historia dueña en la cabecera; lo que faltaba era **dejarlo verificado y darle a la historia una fase donde bajen sus cambios**.

Con esto, el capítulo `11` y sus **5 reglas** dejan de ser texto sin dueño declarado: tienen historia, y la historia tiene por dónde recibir un cambio.
...
|---|---|---|---|---|
| CA-01 — el capítulo nombra su historia dueña | doc | `base/11-configuracion-entornos.md`, su cabecera | ✅ | El enlace **resuelve** |
| CA-02 — un cambio tiene dónde bajarse | doc | `HU-024-el-capitulo-11-configuracion-y-entornos.md` §8 | ✅ | `validar.py fases` deja de reclamar |
...
| T-01 | La cabecera nombra y el enlace resuelve | ✅ hecha | `base/11-configuracion-entornos.md` | `CP-001` |
| T-02 | La historia recibe la fila | ✅ hecha | `HU-024-el-capitulo-11-configuracion-y-entornos.md` | `CP-002` |
...
- **Punto de entrada:** la cabecera del capítulo `11`. Quien vaya a cambiarlo lee ahí por dónde baja el cambio.
