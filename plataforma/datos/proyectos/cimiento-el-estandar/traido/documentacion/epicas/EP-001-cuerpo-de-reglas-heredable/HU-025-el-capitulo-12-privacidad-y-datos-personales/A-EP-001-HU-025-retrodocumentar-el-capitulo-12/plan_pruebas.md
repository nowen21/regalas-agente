# Plan de Pruebas — Fase `A-EP-001-HU-025-retrodocumentar-el-capitulo-12`   ·   `[CAPA 3]`

**Para qué sirve este documento.** Dice **con qué casos concretos se comprueba** el criterio de esta fase, con qué datos y cuándo se da por aprobado. Lo que se pide vive en la [HU-025](../HU-025-el-capitulo-12-privacidad-y-datos-personales.md); lo que se va a hacer, en el [plan_trabajo.md](plan_trabajo.md).
...
Comprobar que el capítulo `12` **nombra su historia dueña con un enlace que resuelve**, y que un cambio suyo **tiene dónde bajarse**.
...
| # | Acción | Resultado esperado |
|---|---|---|
| 1 | Abrir `base/12-privacidad-datos.md` y leer su cabecera | Nombra la HU-025 |
...
| # | Acción | Resultado esperado |
|---|---|---|
| 1 | Comprobar que la HU-025 existe con su documento | Existe |
