# Resultado de Pruebas — Fase `A-EP-001-HU-025-retrodocumentar-el-capitulo-12`   ·   `[CAPA 3]`
...
| Campo | Valor |
|---|---|
| **Fase** (`02·F12.6`) | `A-EP-001-HU-025-retrodocumentar-el-capitulo-12` |
| **HU** | [HU-025](../HU-025-el-capitulo-12-privacidad-y-datos-personales.md) |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Abrir `base/12-privacidad-datos.md` y leer su cabecera | Nombra la HU-025 | Nombra la HU-025 |
| 2 | Comprobar que el enlace apunta a un archivo que **existe** | Resuelve | `../documentacion/epicas/EP-001-cuerpo-de-reglas-heredable/HU-025-el-capitulo-12-privacidad-y-datos-personales/HU-025-el-capitulo-12-privacidad-y-datos-personales.md` → **resuelve** |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Comprobar que la HU-025 existe | Existe | Existe |
...
| CP-001 | CA-01 | **Crítica** | 2026-08-28 | la cabecera de `base/12-privacidad-datos.md`, y su enlace **resuelve** | Aprobado | EV-01 | — |
...
|---|---|---|---|
| CA-01 — el capítulo nombra su historia dueña | CP-000, CP-001 | Nombra la HU-025, y el enlace **resuelve** | Sí |
...
| EV-01 | La cabecera del capítulo | `base/12-privacidad-datos.md` |
