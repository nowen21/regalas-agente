# Plan de Trabajo — Fase `A-EP-001-HU-027-retrodocumentar-el-capitulo-14`   ·   `[CAPA 3]`

**Para qué sirve este documento.** Dice **qué se va a hacer en esta fase, en qué orden, sobre qué archivos y cómo se comprueba** cada criterio de aceptación antes de darlo por cumplido. Lo que se pide vive en la [HU-027](../HU-027-el-capitulo-14-estructura-del-codigo-y-nomenclatura.md); con qué casos se comprueba, en el [plan_pruebas.md](plan_pruebas.md).
...
**Dejar comprobado que el capítulo `14` tiene historia dueña declarada, y que un cambio suyo tiene por dónde bajarse.**
...
| Reglas del capítulo `14` | **3** | `metareglas.reglas()`, no contadas a mano |
| Forma del capítulo en el disco | archivo suelto | `retrodocumentar-los-capitulos.py` |
| Fases que tenía la HU-027 antes de esta | **0** | `validar.py fases` |
...
|---|---|---|
| El capítulo `base/14-estructura-codigo.md` | **Existe** | No se toca |
| Su cabecera con la historia dueña enlazada | **Ya está** | Es el `CA-01`, cumplido |
| La [HU-027](../HU-027-el-capitulo-14-estructura-del-codigo-y-nomenclatura.md) | **Escrita** | Es el `CA-02`: el sitio donde baja un cambio |
...
| `HU-027-el-capitulo-14-estructura-del-codigo-y-nomenclatura.md` §8 | La fila de la fase, y el estado |
...
| T-01 | Comprobar que la cabecera del `14` nombra su historia **y el enlace resuelve** | Test | 0,3 h | T-00 | EV-01 |
| T-02 | Comprobar que la HU-027 existe y su §8 admite la fila | Test | 0,2 h | — | EV-02 |
...
|---|---|---|---|---|
| CA-01 · el capítulo nombra su historia dueña | El programa sobre las 21, y el enlace resuelto | EV-00, EV-01 | Nombra la HU-027 | ☑ |
