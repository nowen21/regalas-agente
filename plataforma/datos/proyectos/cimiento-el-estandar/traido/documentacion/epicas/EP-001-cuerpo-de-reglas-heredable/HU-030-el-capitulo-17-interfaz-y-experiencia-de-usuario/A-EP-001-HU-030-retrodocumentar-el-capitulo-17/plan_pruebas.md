# Plan de Pruebas — Fase `A-EP-001-HU-030-retrodocumentar-el-capitulo-17`   ·   `[CAPA 3]`

**Para qué sirve este documento.** Dice **con qué casos concretos se comprueba** el criterio de esta fase, con qué datos y cuándo se da por aprobado. Lo que se pide vive en la [HU-030](../HU-030-el-capitulo-17-interfaz-y-experiencia-de-usuario.md); lo que se va a hacer, en el [plan_trabajo.md](plan_trabajo.md).
...
Comprobar que el capítulo `17` **nombra su historia dueña con un enlace que resuelve**, y que un cambio suyo **tiene dónde bajarse**.
...
| # | Acción | Resultado esperado |
|---|---|---|
| 1 | Abrir `base/17-interfaz.md` y leer su cabecera | Nombra la HU-030 |
...
| # | Acción | Resultado esperado |
|---|---|---|
| 1 | Comprobar que la HU-030 existe con su documento | Existe |
