# Resultado de Pruebas — Fase `A-EP-001-HU-030-retrodocumentar-el-capitulo-17`   ·   `[CAPA 3]`
...
| Campo | Valor |
|---|---|
| **Fase** (`02·F12.6`) | `A-EP-001-HU-030-retrodocumentar-el-capitulo-17` |
| **HU** | [HU-030](../HU-030-el-capitulo-17-interfaz-y-experiencia-de-usuario.md) |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Abrir `base/17-interfaz.md` y leer su cabecera | Nombra la HU-030 | Nombra la HU-030 |
| 2 | Comprobar que el enlace apunta a un archivo que **existe** | Resuelve | `../documentacion/epicas/EP-001-cuerpo-de-reglas-heredable/HU-030-el-capitulo-17-interfaz-y-experiencia-de-usuario/HU-030-el-capitulo-17-interfaz-y-experiencia-de-usuario.md` → **resuelve** |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Comprobar que la HU-030 existe | Existe | Existe |
...
| CP-001 | CA-01 | **Crítica** | 2026-08-28 | la cabecera de `base/17-interfaz.md`, y su enlace **resuelve** | Aprobado | EV-01 | — |
...
|---|---|---|---|
| CA-01 — el capítulo nombra su historia dueña | CP-000, CP-001 | Nombra la HU-030, y el enlace **resuelve** | Sí |
...
| EV-01 | La cabecera del capítulo | `base/17-interfaz.md` |
