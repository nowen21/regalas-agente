# Funcionalidad implementada — Fase `A-EP-001-HU-031-retrodocumentar-el-capitulo-18` (módulo Cuerpo de reglas)   ·   `[CAPA 3]`
...
| Campo | Valor |
|---|---|
| **Fase** (identificador · `02·F12.6`) | `A-EP-001-HU-031-retrodocumentar-el-capitulo-18` |
| **Módulo** | Cuerpo de reglas |
| **Especificación del módulo** | La redacción de los CA de la [HU-031](../HU-031-el-capitulo-18-despliegue-e-infraestructura.md) es la especificación funcional (`02·F19`) |
| **Plan de trabajo** | [plan_trabajo.md](plan_trabajo.md) |
| **HU / CA cubiertas** | HU-031 (CA-01, CA-02) |
...
**Nada: se comprobó.** Es retro-documentación (`13·DOC6`). El capítulo `18` ya nombraba su historia dueña en la cabecera; lo que faltaba era **dejarlo verificado y darle a la historia una fase donde bajen sus cambios**.

Con esto, el capítulo `18` y sus **8 reglas** dejan de ser texto sin dueño declarado: tienen historia, y la historia tiene por dónde recibir un cambio.
...
|---|---|---|---|---|
| CA-01 — el capítulo nombra su historia dueña | doc | `base/18-despliegue-e-infraestructura.md`, su cabecera | ✅ | El enlace **resuelve** |
| CA-02 — un cambio tiene dónde bajarse | doc | `HU-031-el-capitulo-18-despliegue-e-infraestructura.md` §8 | ✅ | `validar.py fases` deja de reclamar |
...
| T-01 | La cabecera nombra y el enlace resuelve | ✅ hecha | `base/18-despliegue-e-infraestructura.md` | `CP-001` |
| T-02 | La historia recibe la fila | ✅ hecha | `HU-031-el-capitulo-18-despliegue-e-infraestructura.md` | `CP-002` |
...
- **Verificaciones manuales** (`08·T4`):
  ...
  - El capítulo tiene **8 regla(s)** donde el analizador las ve.
...
- **Punto de entrada:** la cabecera del capítulo `18`. Quien vaya a cambiarlo lee ahí por dónde baja el cambio.
