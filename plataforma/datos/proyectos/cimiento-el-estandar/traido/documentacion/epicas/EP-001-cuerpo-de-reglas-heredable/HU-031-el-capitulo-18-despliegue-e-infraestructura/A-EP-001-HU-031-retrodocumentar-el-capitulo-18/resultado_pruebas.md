# Resultado de Pruebas — Fase `A-EP-001-HU-031-retrodocumentar-el-capitulo-18`   ·   `[CAPA 3]`
...
| Campo | Valor |
|---|---|
| **Fase** (`02·F12.6`) | `A-EP-001-HU-031-retrodocumentar-el-capitulo-18` |
| **HU** | [HU-031](../HU-031-el-capitulo-18-despliegue-e-infraestructura.md) |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Abrir `base/18-despliegue-e-infraestructura.md` y leer su cabecera | Nombra la HU-031 | Nombra la HU-031 |
| 2 | Comprobar que el enlace apunta a un archivo que **existe** | Resuelve | `../documentacion/epicas/EP-001-cuerpo-de-reglas-heredable/HU-031-el-capitulo-18-despliegue-e-infraestructura/HU-031-el-capitulo-18-despliegue-e-infraestructura.md` → **resuelve** |
...
| # | Qué hacer | Qué tiene que pasar | Qué salió |
|---|---|---|---|
| 1 | Comprobar que la HU-031 existe | Existe | Existe |
...
| CP-001 | CA-01 | **Crítica** | 2026-08-28 | la cabecera de `base/18-despliegue-e-infraestructura.md`, y su enlace **resuelve** | Aprobado | EV-01 | — |
...
| 2 | Que el capítulo tiene sus reglas donde el analizador las ve | `metareglas.reglas()` | **8 regla(s)** |
...
|---|---|---|---|
| CA-01 — el capítulo nombra su historia dueña | CP-000, CP-001 | Nombra la HU-031, y el enlace **resuelve** | Sí |
...
| EV-01 | La cabecera del capítulo | `base/18-despliegue-e-infraestructura.md` |
