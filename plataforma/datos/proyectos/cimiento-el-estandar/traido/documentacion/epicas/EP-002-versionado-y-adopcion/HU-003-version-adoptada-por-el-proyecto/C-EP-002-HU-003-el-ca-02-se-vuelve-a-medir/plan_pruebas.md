# Plan de Pruebas — Fase `C-EP-002-HU-003-el-ca-02-se-vuelve-a-medir`   ·   `[CAPA 3]`
...
Comprobar que **CA-02**, que la fase `A-EP-002-HU-003-retrodocumentar-la-version-adoptada` dejó en rojo el
...
- [HU-003](../HU-003-version-adoptada-por-el-proyecto.md)
- [Resultado de la fase roja](../A-EP-002-HU-003-retrodocumentar-la-version-adoptada/resultado_pruebas.md)
...
|---|---|
| CA-02 · Una versión que no existe se detecta | Es lo que quedó en rojo |
...
| CA | Caso |
|---|---|
| CA-02 · Una versión que no existe se detecta | CP-001, CP-002 |
...
| **Tipo** | De ejecución |
| **Prioridad** | Alta |
| **Cómo** | Se arma un proyecto de prueba en una carpeta temporal cuyo `CLAUDE.md` declara `99.9.9`, y se corre `version.validar` sobre él. Tiene que salir una **falla**, no un silencio. |
...
| Campo | Valor |
|---|---|
| **HU / CA** | HU-003 / CA-02, contraprueba |
| **Tipo** | Que **no** pase |
| **Prioridad** | **Crítica** |
| **Cómo** | Se mide sobre una carpeta temporal y no sobre un proyecto real, como manda la decisión 35 del pendiente 59: tocar el `CLAUDE.md` de un proyecto vivo para probar es cambiarle el estado a alguien más. |
