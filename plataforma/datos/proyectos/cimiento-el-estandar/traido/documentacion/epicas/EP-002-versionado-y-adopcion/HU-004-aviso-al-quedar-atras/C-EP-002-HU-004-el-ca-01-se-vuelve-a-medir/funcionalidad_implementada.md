# Funcionalidad implementada — Fase `C-EP-002-HU-004-el-ca-01-se-vuelve-a-medir` (módulo Enganches de sesión)   ·   `[CAPA 3]`
...
| **HU / CA cubiertas** | [HU-004](../HU-004-aviso-al-quedar-atras.md): CA-01 · El proyecto atrasado recibe el aviso al abrir sesión |
...
| **Reemplaza el veredicto de** | `A-EP-002-HU-004-retrodocumentar-el-aviso-de-desfase` |

> **Por qué se declara el reemplazo:** se volvió a verificar CA-01, ejecutándolo, y hoy se cumple. Aquel rojo era cierto el 2026-08-22. **El veredicto de aquella fase no se toca** (`20·M11`): la cuenta lo deja atrás, el documento sigue diciendo lo que decía.
...
La fase [`A-EP-002-HU-004-retrodocumentar-el-aviso-de-desfase`](../A-EP-002-HU-004-retrodocumentar-el-aviso-de-desfase/resultado_pruebas.md) cerró en rojo el
2026-08-22 porque el aviso **existía y decía lo que tenía que decir**, pero solo aparecía si alguien escribía el comando a mano: ni `sesion.py` ni `cargador.py` nombraban la versión, y el criterio dice «al abrir sesión», y **era cierto**. Lo resolvió después
...
| Antes | Ahora |
|---|---|
| CA-01 · El proyecto atrasado recibe el aviso al abrir sesión, en rojo desde el 2026-08-22 | **Cumple**, comprobado ejecutando |
...
|---|---|---|---|---|
| CA-01 · El proyecto atrasado recibe el aviso al abrir sesión | comprobación | `B-EP-002-HU-004-el-aviso-llega-al-abrir-y-dice-que-cambio` | ✅ | CP-001, CP-002 |

### 2.2 Plan de trabajo → ejecución

| Tarea | Estado | Evidencia |
|---|---|---|
| T-01 · ejecutar el criterio | ✅ | sale, y `hook_sesion` -> `sesion.revisar` -> `version.validar` |
