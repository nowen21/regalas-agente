# Plan de Trabajo — Fase `C-EP-004-HU-003-el-transversal-de-errores-se-vuelve-a-medir` (módulo Comprobación automática)   ·   `[CAPA 3]`
...
| **HU** | [HU-003](../HU-003-formato-del-hallazgo.md) — **una sola** (`F12.1`) |
...
**Objetivo:** comprobar, ejecutando, que **el transversal de errores hoy se cumple**, y dejarlo declarado donde se lee.

**Fuera de alcance:**

- **Construir nada.** El trabajo ya está hecho; lo que falta es que alguien vuelva a mirarlo.
- **Tocar la fase `A-EP-004-HU-003-retrodocumentar-el-formato-del-hallazgo`.** Su veredicto fue cierto el día que se escribió.
...
Una carpeta con dos archivos: uno con bytes que no son UTF-8 y otro con dos rayas largas en prosa. La corrida tiene que terminar en 0, sin volcado, **y seguir contando las dos marcas del legible**.

**Y por qué la medición no se da por buena de más.** No basta con que no se caiga. Un programa que se traga el error y deja de mirar el resto también «no se cae», y sería peor: diría cero marcas sobre un árbol sin revisar.

**Resultado de la medición:** termina en 0, sin volcado, y cuenta las 2 marcas del legible
...
| `HU-003-formato-del-hallazgo.md` | Modificar | Documentación | Su `Estado` nombra el criterio en rojo |
...
|---|---|---|---|
| Transversal de errores · un `.md` ilegible no tumba la corrida | Ejecutar el criterio, con su contraprueba | EV-01, EV-02 | ☑ |
