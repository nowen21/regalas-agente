# Estado de fase — Fase «C-EP-005-HU-003-el-veredicto-se-copia-solo» (módulo «Automatismos — enganches»)   ·   `[CAPA 3]`
...
| **Planteamiento / Épica / HU** | [EP-005](../../epica.md) · [HU-003](../HU-003-disparo-al-escribir-un-archivo.md) · pendiente 70 |
...
| Tarea | Estado | Nota |
|---|---|---|
| T-01 | Hecha | `validadores/veredicto.py` |
| T-02 | Hecha | `hook_veredicto.py` enchufado |
| T-03 | Hecha | `_fila_hecha()` en `cerrar.py` |
| T-04 | Hecha | 6 casos en verde |
| T-05 | Hecha | Especificación, mapas, 9 de 9 proyectos |
...
|---|---|
| Solo con concepto escrito; el checkpoint no se toca | S-013 en `documentacion/senales.md` |
