...
|---|---|---|
| [A-EP-005-HU-005-el-cambio-de-reglas-no-se-guarda-sin-version](A-EP-005-HU-005-el-cambio-de-reglas-no-se-guarda-sin-version/README.md) | CA-01 y CA-02 | Abierta 2026-08-17, con su plan de trabajo escrito y sin aprobar |

**La fase construye.** `20·M10` exige entrada en el registro y subida de versión con cada cambio de regla, y **nada lo impide**: hoy se sostiene a pulso, y por eso el `CLAUDE.md` del repositorio tiene que repetir que versionar no es opcional.
