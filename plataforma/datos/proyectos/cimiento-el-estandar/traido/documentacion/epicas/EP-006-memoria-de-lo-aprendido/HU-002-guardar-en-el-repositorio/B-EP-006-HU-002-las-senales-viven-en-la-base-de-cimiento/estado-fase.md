# Estado de fase — Fase `B-EP-006-HU-002-las-senales-viven-en-la-base-de-cimiento` (módulo Memoria)   ·   `[CAPA 3]`
...
| **Módulo** | Memoria |
| **Planteamiento / Épica / HU** | [EP-006](../../epica.md) · [HU-002](../HU-002-guardar-en-el-repositorio.md) |
...
|---|---|
| **Concepto** | **Cumple** |
| **CA cumplidos** | 1 de 1, el CA-01, lo guardado vive en el repositorio con su historial |
| **CA en "No"** | Ninguno |
