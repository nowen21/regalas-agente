# Estado de fase — Fase `B-EP-006-HU-006-se-lleva-todo-y-el-almacen-queda-vacio` (módulo Memoria)   ·   `[CAPA 3]`
...
| **Módulo** | Memoria |
| **Planteamiento / Épica / HU** | [EP-006](../../epica.md) · [HU-006](../HU-006-sacar-del-almacen-local.md) |
...
|---|---|
| **Concepto** | **Cumple** |
| **CA cumplidos** | 1 de 1, el CA-01, el almacén local queda vacío |
| **CA en "No"** | Ninguno |
