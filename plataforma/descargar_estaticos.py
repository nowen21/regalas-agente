# -*- coding: utf-8 -*-
"""Descarga los estáticos de terceros de la plataforma, pineados por versión y huella.
...
git que `collectstatic` junta con lo propio de `static/`, y la plataforma sigue funcionando sin internet después de instalada (`RNF-03`).
...
Se corre una vez tras clonar:  python plataforma/descargar_estaticos.py

**Es el mismo archivo que el del visor, y con las mismas huellas.** Se copió en vez
de compartirse porque las dos aplicaciones se instalan por separado; si las
versiones se separan algún día, cada una fija la suya.
"""
import hashlib
import io
import os
...
if __name__ == "__main__":
    print("Estáticos de la plataforma (pineados por versión y huella):")
    n = descargar()
