...
| `conteo.py` | [conteo.md](conteo.md) | Al terminar la corrida completa, dice por cuál regla se incumple más, y guarda solo el número. |
| `plan_vs_hecho.py` | [plan_vs_hecho.md](plan_vs_hecho.md) | Lo que la fase tocó contra lo que su plan declaró, y los criterios contra sus casos. |
